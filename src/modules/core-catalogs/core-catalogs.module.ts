...
export const coreCatalogs: CatalogDefinition[] = [
  ...
  { slug: 'languages', table: 'languages', title: 'Idiomas', description: 'Idiomas soportados por la plataforma', primaryKey: 'language_id', fields: [{key:'code',label:'Código',type:'text',required:true},{key:'name',label:'Nombre',type:'text',required:true},{key:'is_active',label:'Activo',type:'boolean'}] },
